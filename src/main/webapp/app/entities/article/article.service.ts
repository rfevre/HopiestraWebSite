...
export class ArticleService {
    ...
    private convertItemFromServer(article: Article): Article {
        ...
        copy.publicationDate = this.dateUtils
            .convertDateTimeFromServer(article.publicationDate);
        copy.updateDate = this.dateUtils
            .convertDateTimeFromServer(article.updateDate);
        copy.creationDate = this.dateUtils
            .convertDateTimeFromServer(article.creationDate);
        copy.deleteDate = this.dateUtils
            .convertDateTimeFromServer(article.deleteDate);
        return copy;
    }
    ...
    private convert(article: Article): Article {
        ...
        copy.publicationDate = this.dateUtils.toDate(article.publicationDate);

        copy.updateDate = this.dateUtils.toDate(article.updateDate);

        copy.creationDate = this.dateUtils.toDate(article.creationDate);

        copy.deleteDate = this.dateUtils.toDate(article.deleteDate);
        return copy;
    }
}
