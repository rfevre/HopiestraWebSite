...
public class ImageResourceIntTest {
    ...
    public void createImage() throws Exception {
        ...
        assertThat(testImage.getImageBlob()).isEqualTo(DEFAULT_IMAGE_BLOB);
        assertThat(testImage.getImageBlobContentType()).isEqualTo(DEFAULT_IMAGE_BLOB_CONTENT_TYPE);
    ...
    @Test
    @Transactional
    public void checkImageBlobIsRequired() throws Exception {
    ...
    public void updateImage() throws Exception {
        ...
        Image testImage = imageList.get(imageList.size() - 1);
        assertThat(testImage.getImageBlob()).isEqualTo(UPDATED_IMAGE_BLOB);
        assertThat(testImage.getImageBlobContentType()).isEqualTo(UPDATED_IMAGE_BLOB_CONTENT_TYPE);
