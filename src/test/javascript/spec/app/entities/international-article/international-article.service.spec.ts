...
describe('Service Tests', () => {
    ...
    describe('InternationalArticle Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(InternationalArticleService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/international-articles';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return InternationalArticle', () => {
